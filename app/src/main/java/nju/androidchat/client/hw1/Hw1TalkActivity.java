...
@Log
public class Hw1TalkActivity extends AppCompatActivity implements Mvp2Contract.TalkView, TextView.OnEditorActionListener, OnRecallMessageRequested {
        ...
        runOnUiThread(() -> {
                    ...
                    for (ClientMessage message : messages) {
                        ...
                        if (message.getSenderUsername().equals(this.presenter.getUsername())) {
                            if(Pattern.matches(pattern,message.getMessage())){
                                String str = message.getMessage();
                                String url = str.substring(str.indexOf("(")+1,str.indexOf(")"));
